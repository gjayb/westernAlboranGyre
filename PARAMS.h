...
cjc(Define Select_Rampa
C     Select_Rampa :: Variable logica, uso de rampa para insercion de la marea
cjc)
      COMMON /PARM_L/
...
cjc(  Defining my variables
C     dia0 :: Dia inicio de la simulacion formato datenum
C     LATcn :: Ver correccion nodal
C     V0cn :: Ver correcion nodal
C     fcn :: Ver correcion nodal
C     ucn :: Ver correcion nodal
C     DtRampa :: Periodo de ajuste inicial forzamiento de marea (en horas)
C     externForcingPeriod_Niv, externForcingCycle_Niv
cjc)
...
cjc(
     & dia0, LATcn, V0cn, fcn, ucn , DtRampa,
     & externForcingPeriod_Niv, externForcingCycle_Niv
cjc)
...
cjc(Defining my variables
      _RL dia0, LATcn, DtRampa
      _RL V0cn(8),fcn(8),ucn(8)
      _RL externForcingPeriod_Niv
      _RL externForcingCycle_Niv
cjc)
