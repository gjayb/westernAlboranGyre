...
notaBene2='dlmin changes from 2km to 2.5km days 77:79';

for j=84; %[10 31:1:61] %0:0.5:21
    j
    clear *tr*
...
%%
   ...
   fn=strcat('wagBoundaryday',num2str(j),'ResolvedD14.mat');
   save(fn,'-v7.3')
    figure
    ...
    fn=strcat('wagBoundaryday',num2str(j),'ResolvedD14.pdf');
    save2pdf(fn)
