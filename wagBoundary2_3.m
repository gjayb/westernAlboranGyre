...
load('uvwIso275interpolated.mat', 'u');
load('uvwIso275interpolated.mat', 'v');
...
for j=110:-1:100;%[9:18 26:57 65:102 107:112 118:127 134:139];%[19:25 58:64 103:106 113:117  128:133];%113:117; %[10 31:1:61] %0:0.5:21
    j
    clear *tr*
    t1=86400*(j-27):86400:(j)*86400;
    t2=(j+27)*86400:-86400:(j)*86400;
