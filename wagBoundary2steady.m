...
load('uvwDailyDepth1interpolatedNF.mat', 'XC','YC','u','v','yvel','xvel','tvel','*Coast')
...
%!! just for steady flow surface case!!
%circleCenters(1,2)=35.96;
...
%!!!!!!! mean flow!!!!!!
u=repmat(nanmean(u(:,:,1:148),3),[1 1 2]);
v=repmat(nanmean(v(:,:,1:148),3),[1 1 2]);
tvel=[tvel(1) tvel(end)];
...
fn='wagBoundarySteadySurfaceInt14NF.mat';   
save(fn,'-v7.3')
   % figure
