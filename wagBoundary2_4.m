...
for j=103:-1:100;%[9:18 26:57 65:102 107:112 118:127 134:139];%[19:25 58:64 103:106 113:117 128:133] %113:117;   %[10 31:1:61] %0:0.5:21
    j
    clear *tr*
    t1=86400*(j-23):86400:(j)*86400;
    t2=(j+23)*86400:-86400:(j)*86400;
...
%%
   ...
   fn=strcat('wagBoundaryday',num2str(j),'Iso27int23.mat');
   save(fn,'-v7.3')
  %  figure
  ...
  %  fn=strcat('wagBoundaryday',num2str(j),'Iso27int8.pdf');
  %  save2pdf(fn)
