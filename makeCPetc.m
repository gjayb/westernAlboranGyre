...
disp('save 1')
save('tsPress162NR.mat','-v7.3')
clear Pref RhoRef Phi
...
load('tsPress162NR.mat','PressDbar')
for k=1:nt
    k
    for di=1:46
...
disp('save 3')
save('tsSigmaSnapshots162NR.mat','-v7.3')

%% 
% momHD=rdmds('momHDave',times);
% load('tsPress162NR.mat','PotTave');
% ThDiv=PotTave.*momHD;
% size(ThDiv)
% clear PotTave
% load('tsPress162NR.mat','PractSave');
% ShDiv=PractSave.*momHD;
% size(ShDiv)
% clear PractSave
% disp('save 4')
% save('divTS162NR.mat','-v7.3')