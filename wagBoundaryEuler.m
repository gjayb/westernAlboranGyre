...
%legend('horizontal','vertical','precipitation','total','WAG volume change from SSH')
%xlabel('Time in Days')
%save2pdf('eulerWAGvolumefluxGrad.pdf')

%figure; plot(0:147,vfluxhExchange./1e6,0:147,vfluxvExchange./1e6)
%title('Wag Eulerian Boundary Exchange Volume Flux in Sverdrups')
%legend('horizontal','vertical')
%xlabel('Time in Days')
%save2pdf('eulerWAGvolumeExchangeGrad.pdf')


%save('volumesfluxesWAGeulerGrad.mat','-v7.3')
%disp('done volume fluxes')
%%
...
hold on; plot(0:147,wagMass-wagMass(1),'m')
...
save2pdf('eulerWAGmassflux148v2.pdf')
...
save2pdf('eulerWAGmassExchange148v2.pdf')

save('massfluxesWAGeulerV2.mat','-v7.3')
