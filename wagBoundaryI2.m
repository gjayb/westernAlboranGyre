...
load('uvwIso2675InterpNF.mat', 'XC','YC','U','V','xvel','yvel','tvel','*Coast')
...
for j=122:148;%[9:18 26:57 65:102 107:112 118:127 134:139];%[19:25 58:64 103:106 113:117  128:133];%113:117; %[10 31:1:61] %0:0.5:21
    j
    clear *tr*
...
disp('convert to lon/lat')
   ...
   fn=strcat('wagBoundaryday',num2str(j),'Iso2675Int14.mat');
