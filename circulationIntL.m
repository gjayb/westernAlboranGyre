function [ integral1, sign1,uds ] = circulationIntL( xum,yum,u,xvm,yvm,v,xs,ys )
%circulationIntL takes in xm,ym the grid in Lat Lon for vector field u,v in
%the east-north directions, and xs,ys in Lat Lon the closed curve around which to
