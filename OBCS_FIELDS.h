...
C     OBCS_ldRec     :: time-record currently loaded (in temp arrays *[1])
      COMMON /OBCS_LOAD_I/ 
     &      OBCS_ldRec,OBCS_ldRec_Niv
      INTEGER OBCS_ldRec(nSx,nSy)
cjc(Defining OBCS_ldRec_Niv
      INTEGER OBCS_ldRec_Niv(nSx,nSy)
cjc)
...
cjc( Defining OBEuNiv0,OBEuNiv1
      _RL OBEuNiv0 (1-Oly:sNy+Oly,nSx,nSy)
      _RL OBEuNiv1 (1-Oly:sNy+Oly,nSx,nSy)
cjc)
# endif /* ALLOW_OBCS_PRESCRIBE */
# ifdef ALLOW_OBCS_STEVENS
...
cjc( Defining OBWuNiv0,OBWuNiv1
      _RL OBWuNiv0 (1-Oly:sNy+Oly,nSx,nSy)
      _RL OBWuNiv1 (1-Oly:sNy+Oly,nSx,nSy)
cjc)
# endif /* ALLOW_OBCS_PRESCRIBE */
# ifdef ALLOW_OBCS_STEVENS
