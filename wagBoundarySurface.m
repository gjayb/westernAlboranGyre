...
circleCenters=zeros(2,2);
    %new try for surface western point
    circleCenters(1:2,:)=[-5.4,35.9;-3.05,35.4];
...
for j=8:148;%[9:18 26:57 65:102 107:112 118:127 134:139];%[19:25 58:64 103:106 113:117  128:133];%113:117; %[10 31:1:61] %0:0.5:21
    j
    clear *tr*
...
disp('convert to lon/lat')
   ...
   fn=strcat('wagBoundaryday',num2str(j),'SurfaceInt8b.mat');
