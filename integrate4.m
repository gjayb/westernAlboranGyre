...
load('uvAdepth1steadyMar.mat');
addpath('../mStuff')

for intLoop=1 %:1:34
    tmesh=(intLoop-1)*86400:3600:(intLoop+9)*86400;
    tmesh2=(intLoop+9)*86400:-3600:(intLoop-1)*86400;
    intLoop
    
	tvel=-1:86401:(31*86401);
...
disp('saving')
fname='/nobackup1/gbrett/trajMITgcmSteadyMarB10day.mat';
save(fname,'-v7.3')
disp('done all')
